"""
ComfyUI Node: Enhanced PDF Image and Text Extractor V0.4.0
Description: 
...
class EnhancedPDFExtractorNode:
    ...
    def _create_enhanced_summary_report(self, reports, total_pdfs, save_options, total_joined, total_enhanced):
        ...
        summary_lines = [
            "=== ENHANCED PDF EXTRACTION SUMMARY V0.4.0 ===",
...
class EnhancedPDFProcessor:
    ...
    def safe_execute(self, func, *args, **kwargs):
        ...
        return self.error_manager.safe_execute(func, *args, **kwargs)
    ...
    def _try_segmentation_cropping(self, image: Image.Image, analysis: Dict) -> Dict[str, Any]:
        """Try segmentation cropping with multiple object handling"""
        ...
        try:
            ...
            if self.debug_mode:
                print(f"    🔍 Segmentation cropping: Found {len(boxes)} bounding boxes")
        ...
        try:
            if len(boxes) == 1:
                ...
                method = "multi_object_encompassing"
            ...
            if self.debug_mode:
                print(f"    ❌ Error in segmentation cropping strategy: {e}")
...
# Node registration
NODE_CLASS_MAPPINGS = {
    "Eric_PDF_Extractor_Enhanced_V04": EnhancedPDFExtractorNode
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "Eric_PDF_Extractor_Enhanced_V04": "Eric PDF Extractor Enhanced v0.4.0"
}